> **Frozen.** This is the completed 2022-2025 project, kept for reference.
> Active work lives in [`../era2026/`](../era2026/PLAN.md).
> All paths below are relative to this `legacy/` directory, not the repository root.
