...
\begin{tabular}{@{}ll@{}}
\toprule
Report & this document (\texttt{era2026/paper/report.pdf}) \\
Code & \url{https://github.com/AminN77/formula1-overtake-prediction} \\
 & installable package \texttt{era2026/}, 88 tests \\
Interactive results & \texttt{era2026/ui/index.html} (opens directly, no server) \\
Design record & \texttt{era2026/DESIGN.md}, \texttt{era2026/PLAN.md} \\
Data reconnaissance & \texttt{era2026/recon\_report.md} \\
Figure generation & \texttt{era2026/paper/figures.py}, \texttt{numbers.json} \\
Prior project & \texttt{legacy/} at tag \texttt{legacy-v6} \\
\bottomrule
\end{tabular}

\medskip
\noindent
Every figure and every number quoted in this report is produced by
\texttt{paper/figures.py} from a run of the pipeline, and regenerates with the
model; none are transcribed by hand.
